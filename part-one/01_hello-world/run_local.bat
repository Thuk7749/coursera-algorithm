...
echo Java Project Compiler and Runner - Local Mode
echo =============================================

REM 1. Use current directory as JAVA_FOLDER
set "JAVA_FOLDER=%CD%"
pushd "%JAVA_FOLDER%" >nul 2>&1
if errorlevel 1 (
    echo Error: Cannot access current directory "%JAVA_FOLDER%".
    exit /b 1
)
